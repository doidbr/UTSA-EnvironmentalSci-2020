...
tx_df <- read.csv('/Users/ssilva/Desktop/genAI/UTSA_env/pudf/TX-county_lfex_pudf.csv', header=TRUE)
...
```{r, include = FALSE}
epa <-read.csv("/Users/ssilva/Desktop/genAI/UTSA_env/tri_2005_tx.csv", header=TRUE)
